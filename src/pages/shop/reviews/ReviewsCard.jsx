                            ...
                            {reviews.map((review, index) => (
                                <div key={index} className='mt-4'>
                                    <div className='flex gap-4 items-center'>
                                        <img className='size-14' src={commentorIcon} alt="user profile image" />
                                        <div className='space-y-1'>
                                            <p className='text-lg font-medium underline underline-offset-4 capitalize text-blue-400'>{review?.userId?.username}</p>
