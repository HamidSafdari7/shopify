  ...
  // dashboard routes start here
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <PrivateRoute role="admin"><AddBlog /></PrivateRoute>
      },
      {
        path: "manage-blogs",
        element: <PrivateRoute role="admin"><ManageBlog /></PrivateRoute>

      },
      {
        path: "update-blog/:id",
        element: <PrivateRoute role="admin"><UpdateBlog /></PrivateRoute>
      },
