    ...
    return (
        <section className='h-screen flex items-center justify-center'>
            <div className='max-w-sm border shadow bg-white mx-auto p-8'>
                ...
                <p className='my-5 italic text-sm text-center'>Already have an account ? <Link className='underline text-indigo-500 hover:text-indigo-700' to="/login">Login </Link>here</p>
            </div>
        </section>
    )
}
